...
Disclaimer first: This work is under a GPL v3.0 license. It is provided "as is", there is no
guarantee of fitness for any particular purpose, nor responsibility for any
possible damage resulting from its use from the part of the authors. Also, this is an independent Android port of the open‑source Aeolus organ software. This not affiliated with or endorsed by the original Aeolus project or any other AEOLUS trademark holder. We hope it can useful, but that's it. 



This software can use the internal keyboard, but also both software midi sources (i.e. virtual keyboard apps) and
...
see for example https://youtu.be/Gb4DhIht6\_s . There is also a corresponding
